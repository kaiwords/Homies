...
class _TenantOnboardingScreenState extends State<TenantOnboardingScreen> {
  ...
  bool get _profileComplete => (_lifestyle?.isComplete ?? false) && (_emergency?.isComplete ?? false);
      ...
      cu.submissions = Submissions(
        idDoc: _idFile == null
            ...
            : IdDocSubmission(
                ...
                url: _idFile!.url,
                storagePath: _idFile!.storagePath,
                type: _idFile!.type,
                size: _idFile!.size,
        ...
        bondProof: _bondFile == null
            ...
            : PaymentSubmission(
                ...
                url: _bondFile!.url,
                storagePath: _bondFile!.storagePath,
                type: _bondFile!.type,
                size: _bondFile!.size,
        ...
        advanceRentProof: _advFile == null
            ...
            : PaymentSubmission(
                ...
                url: _advFile!.url,
                storagePath: _advFile!.storagePath,
                type: _advFile!.type,
                size: _advFile!.size,
  ...
  Widget _stepBody(Property p, double bondAmount, double advanceAmount, HomiesState state) {
    switch (_step) {
      ...
      default:
        return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          const Text('Lifestyle & emergency contact', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
          const Text('Every housemate fills these in so the house knows who they’re living with.',
              style: TextStyle(color: HomiesColors.textDim)),
          const SizedBox(height: 12),

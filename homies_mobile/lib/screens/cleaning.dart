    ...
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          HomiesCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
              const Text("This week's roster", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
              Text(isLeaseholder ? 'Edit area + assignee per day.' : 'Leaseholder sets the schedule.',

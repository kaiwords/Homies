        ...
        child: Row(children: [
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(isGroup ? 'Everyone living here.' : 'Just the two of you.',
                ...
                itemBuilder: (_, i) {
                  ...
                  if (m.type == 'poll' && m.poll != null) {
                    ...
                    bubble = Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        if (!mine)
                          Text(sender?.name ?? '—', style: const TextStyle(fontSize: 11, color: HomiesColors.textDim, fontWeight: FontWeight.w600)),
                        Text(m.text,
                            style: TextStyle(color: mine ? Colors.white : HomiesColors.text, fontSize: 14)),
                      ]),
                    );
                  }
                  return Padding(
      ...
      Container(
        ...
        child: Row(children: [
          IconButton(
            ...
            onPressed: () => _openPollComposer(state),
          ),
          Expanded(
            child: TextField(
          ...
          ElevatedButton(onPressed: () => _send(state), child: const Text('Send')),
        ]),
      ),
    ]);
  }
